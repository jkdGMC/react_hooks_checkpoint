  ...
  return (
    <div className="form_component">
      <form className='add-form' >
        ...
        <input type="text" placeholder='Trailer URL' value={newMovie.trailerLink} onChange={e => {setNewMovie({...newMovie, trailerLink : e.target.value})}} required/>
        <textarea cols="25" rows="10" placeholder='Description...' value={newMovie.description} onChange={e => {setNewMovie({...newMovie, description : e.target.value})}} required></textarea>
